...
(function () {
  ...
  function QueryFactory($http) {
    ...
    function submit(query) {
      return $http.post('api/db/query', JSON.stringify({
        'data': query
      }))
        .then(submitComplete)
        .catch(submitFailed);
  ...
  function Tables($http) {
    ...
    function getTables(databaseName) {
      return $http({
        method: 'GET',
        url: 'api/db/' + databaseName + '/tables'
      })
    ...
    function dropTable(databaseName, tableName) {
      return $http({
        method: 'DELETE',
        url: 'api/db/' + databaseName + '/' + tableName + ''
      })
    ...
    function createTable(database, table, schema) {
      return $http({
        method: 'POST',
        url: ['api/db', database, table].join('/'),
        data: schema
      })
    }
  ...
  function Users($http) {
    ...
    function deleteUser(user, host) {
      return $http({
        method: 'DELETE',
        url: 'api/settings/users/' + user + '/' + host + '/'
      })
    ...
    function getGrantsRecord(user, host) {
      return $http({
        method: 'GET',
        url: 'api/settings/users/' + user + '/' + host + '/grantsrecord/'
      })
    ...
    function getGrantsDescription() {
      return $http({
        method: 'GET',
        url: 'api/settings/users/grantsdescription'
      })
